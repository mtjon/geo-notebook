# Geo Processing-oriented Jupyter notebook Stack
Simple extension based on [Jupyter Notebook Datascience Stack][1].

## What it Gives You
- Everything from Jupyter Notebook Datascience Stack:
    + Jupyter Notebook 5.0.x
    + Conda Python 3.x and Python 2.7.x environments
    + pandas, matplotlib, scipy, seaborn, scikit-learn, scikit-image, sympy, cython, patsy, statsmodel, cloudpickle, dill, numba, bokeh pre-installed
    + and [much, MUCH more&#8230;!][1]
- geopandas pre-installed.
...
[1]: https://github.com/mtjon/docker-stacks/tree/master/datascience-notebook
